                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      {cocinera.phone && tieneAsignaciones && (
                        <a
                          href={construirUrlWhatsAppInventario(cocinera, cocinera.asignaciones)}
                          target="_blank"
                          rel="noopener noreferrer"
                          onClick={(e) => e.stopPropagation()}
                          className="p-1.5 rounded-lg text-[#25D366] hover:bg-[#25D366]/10 transition-colors shrink-0 flex-shrink-0"
                          title="Enviar WhatsApp con listado"
                        >
