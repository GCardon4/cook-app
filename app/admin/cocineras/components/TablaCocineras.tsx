...
import { eliminarCocinera } from '../actions'
...
export default function TablaCocineras({ cocineras }: Props) {
            ...
            {cocinerasFiltradas.map((cocinera) => (
              ...
              >
                ...
                {cocinera.escuelas.length > 0 ? (
                  ...
                  <p className="text-xs text-secondary mb-3">Sin escuela asignada</p>
                )}
